...
def q2():
    alpha = 0.05
    jarque = sct.jarque_bera(get_sample(athletes, 'height', n=3000))
    return bool(jarque[1] > alpha)
...
def q3():
    alpha = 0.05
    normal_test = sct.normaltest(get_sample(athletes, 'weight', n=3000))
    return bool(normal_test[1] > alpha)
...
def q4():
    ...
    p_value = sct.normaltest(get_sample(athletes, 'weight_log', n=3000))[1]
...
# nations = ['BRA', 'USA', 'CAN']
# athletes_bra_usa_can = athletes.query('nationality == @nations')
